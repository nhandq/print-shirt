    ...
    <div>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tác vụ chưa hoàn thành</h4>
                        <h6 class="card-subtitle" v-if="!recent_incomplete_tasks.length">Chưa có tác vụ nào!</h6>
                ...
                <div class="card">
                    <div class="card-body b-b">
                        ...
                        <form @submit.prevent="storeTodo">
                            <div class="row">
                                <div class="col-8">
                                    <textarea placeholder="Thêm một việc cần làm..." class="form-control b-0" v-model="todoForm.todo"></textarea>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle" v-if="!todos.length">Chưa có việc nào!</h6>
                    </div>
                </div>
            </div>
        </div>
