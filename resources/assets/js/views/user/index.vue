            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle" v-if="users.total">Tổng {{users.total}} tài khoản!</h6>
                        <h6 class="card-subtitle" v-else>Chưa có tài khoản nào!</h6>
                                    ...
                                    <tr v-for="user in users.data">
                                        ...
                                        <td>
                                            <click-confirm yes-class="btn btn-success" no-class="btn btn-danger">
                                                <button class="btn btn-success btn-sm" @click.prevent="deleteUser(user)" data-toggle="tooltip" title="Chỉnh sửa"><i class="fa fa-edit"></i></button>
        ...
        methods: {
            ...
            getUserStatus(user){
                if(user.status == 'pending_activation')
                    ...
                    return '<span class="label label-danger">Bị khóa</span>';
                else
                    return;
            }
        },
