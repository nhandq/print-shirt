<template>
  <div>
    ...
    <div class="row">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <datepicker v-model="customer.birthday" placeholder="Ngày sinh" :bootstrapStyling="true"></datepicker>
            </div>
            <div class="form-group">
      ...
      <button style="left: 45%" type="submit" class="btn btn-info waves-effect waves-light m-t-10" @click="addOrder">Lưu thay đổi</button>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
        getOrderDetail(page) {
            ...
            axios.get('/api/order/' + this.$route.params.id)
                .then((response) => {
                    ...
                    self.cart = response.data.data.orderDetail;
                    self.customer = response.data.data.customer;
                    self.shippingAddress = response.data.data.shipping ;
        ...
        addOrder() {
            ...
            axios.post('/api/update-order/' + this.$route.params.id, data).then(response => {
